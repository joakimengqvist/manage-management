...
func (app *Config) CreateInvoiceNote(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		log.Println("http.NewRequest - CreateInvoiceNote", err)
		app.errorJSON(w, err)
		return
	}
	...
	if err != nil {
		log.Println("client.Do - CreateInvoiceNote", err)
		app.errorJSON(w, err)
		return
	}
	...
	if err != nil {
		log.Println("json.NewDecoder - CreateInvoiceNote", err)
		app.errorJSON(w, err)
		return
	}
...
func (app *Config) UpdateInvoiceNote(w http.ResponseWriter, r *http.Request) {
	...
	request, err := http.NewRequest("POST", endpoint, bytes.NewBuffer(jsonData))
	if err != nil {
		log.Println("POST - UpdateInvoiceNote", err)
		app.errorJSON(w, err)
		return
	}
	...
	response, err := client.Do(request)
	if err != nil {
		log.Println("client.Do - UpdateInvoiceNote", err)
		app.errorJSON(w, err)
		return
	}
	...
	err = json.NewDecoder(response.Body).Decode(&jsonFromService)
	if err != nil {
		log.Println("json.NewDecoder - UpdateInvoiceNote", err)
		app.errorJSON(w, err)
		return
	}
...
func (app *Config) GetInvoiceNoteById(w http.ResponseWriter, r *http.Request) {
	...
	request, err := http.NewRequest("POST", endpoint, bytes.NewBuffer(jsonData))
	if err != nil {
		log.Println("POST - GetInvoiceNoteById", err)
		app.errorJSON(w, err)
		return
	}
	...
	response, err := client.Do(request)
	if err != nil {
		log.Println("client.Do - GetInvoiceNoteById", err)
	...
	err = json.NewDecoder(response.Body).Decode(&jsonFromService)
	if err != nil {
		log.Println("json.NewDecoder - GetInvoiceNoteById", err)
		app.errorJSON(w, err)
		return
	}
...
func (app *Config) GetAllInvoiceNotesByInvoiceId(w http.ResponseWriter, r *http.Request) {
	...
	request, err := http.NewRequest("POST", endpoint, bytes.NewBuffer(jsonData))
	if err != nil {
		log.Println("POST - GetAllInvoiceNotesByInvoiceId", err)
		app.errorJSON(w, err)
		return
	}
	...
	response, err := client.Do(request)
	if err != nil {
		log.Println("client.Do - GetAllInvoiceNotesByInvoiceId", err)
		app.errorJSON(w, errors.New("could not fetch invoice note"))
		return
	}
	...
	err = json.NewDecoder(response.Body).Decode(&jsonFromService)
	if err != nil {
		log.Println("json.NewDecoder - GetAllInvoiceNotesByInvoiceId", err)
		app.errorJSON(w, err)
		return
	}
...
func (app *Config) GetAllInvoiceNotesByUserId(w http.ResponseWriter, r *http.Request) {
	...
	request, err := http.NewRequest("POST", endpoint, bytes.NewBuffer(jsonData))
	if err != nil {
		log.Println("POST - GetAllInvoiceNotesByUserId", err)
		app.errorJSON(w, err)
		return
	}
	...
	response, err := client.Do(request)
	if err != nil {
		log.Println("client.Do - GetAllInvoiceNotesByUserId", err)
		app.errorJSON(w, errors.New("could not fetch invoice note"))
		return
	}
	...
	err = json.NewDecoder(response.Body).Decode(&jsonFromService)
	if err != nil {
		log.Println("json.NewDecoder - GetAllInvoiceNotesByUserId", err)
		app.errorJSON(w, err)
		return
	}
...
func (app *Config) DeleteInvoiceNote(w http.ResponseWriter, r *http.Request) {
	...
	request, err := http.NewRequest("POST", endpoint, bytes.NewBuffer(jsonData))
	if err != nil {
		log.Println("POST - DeleteInvoiceNote", err)
		app.errorJSON(w, err)
		return
	}
	...
	response, err := client.Do(request)
	if err != nil {
		log.Println("client.Do - DeleteInvoiceNote", err)
	...
	err = json.NewDecoder(response.Body).Decode(&jsonFromService)
	if err != nil {
		log.Println("json.NewDecoder - DeleteInvoiceNote", err)
		app.errorJSON(w, err)
		return
	}
