...
func (app *Config) CreateSubProjectNote(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		log.Println("json.NewDecoder - CreateSubProjectNote", err)
		app.errorJSON(w, err)
		return
	}
...
func (app *Config) UpdateSubProjectNote(w http.ResponseWriter, r *http.Request) {
	...
	request, err := http.NewRequest("POST", endpoint, bytes.NewBuffer(jsonData))
	if err != nil {
		log.Println("POST - UpdateSubProjectNote", err)
		app.errorJSON(w, err)
		return
	}
	...
	response, err := client.Do(request)
	if err != nil {
		log.Println("client.Do - UpdateSubProjectNote", err)
		app.errorJSON(w, err)
		return
	}
	...
	err = json.NewDecoder(response.Body).Decode(&jsonFromService)
	if err != nil {
		log.Println("json.NewDecoder - UpdateSubProjectNote", err)
		app.errorJSON(w, err)
		return
	}
...
func (app *Config) GetSubProjectNoteById(w http.ResponseWriter, r *http.Request) {
	...
	request, err := http.NewRequest("POST", endpoint, bytes.NewBuffer(jsonData))
	if err != nil {
		log.Println("POST - GetSubProjectNoteById", err)
		app.errorJSON(w, err)
		return
	}
	...
	response, err := client.Do(request)
	if err != nil {
		log.Println("client.Do - GetSubProjectNoteById", err)
	...
	err = json.NewDecoder(response.Body).Decode(&jsonFromService)
	if err != nil {
		log.Println("json.NewDecoder - GetSubProjectNoteById", err)
		app.errorJSON(w, err)
		return
	}
...
func (app *Config) GetAllSubProjectNotesBySubProjectId(w http.ResponseWriter, r *http.Request) {
	...
	request, err := http.NewRequest("POST", endpoint, bytes.NewBuffer(jsonData))
	if err != nil {
		log.Println("POST - GetAllSubProjectNotesBySubProjectId", err)
		app.errorJSON(w, err)
		return
	}
	...
	response, err := client.Do(request)
	if err != nil {
		log.Println("client.Do - GetAllSubProjectNotesBySubProjectId", err)
		app.errorJSON(w, errors.New("could not fetch project note"))
		return
	}
	...
	err = json.NewDecoder(response.Body).Decode(&jsonFromService)
	if err != nil {
		log.Println("json.NewDecoder - GetAllSubProjectNotesBySubProjectId", err)
		app.errorJSON(w, err)
		return
	}
...
func (app *Config) GetAllSubProjectNotesByUserId(w http.ResponseWriter, r *http.Request) {
	...
	request, err := http.NewRequest("POST", endpoint, bytes.NewBuffer(jsonData))
	if err != nil {
		log.Println("POST - GetAllSubProjectNotesByUserId", err)
		app.errorJSON(w, err)
		return
	}
	...
	response, err := client.Do(request)
	if err != nil {
		log.Println("client.Do - GetAllSubProjectNotesByUserId", err)
		app.errorJSON(w, errors.New("could not fetch project note"))
		return
	}
	...
	err = json.NewDecoder(response.Body).Decode(&jsonFromService)
	if err != nil {
		log.Println("json.NewDecoder - GetAllSubProjectNotesByUserId", err)
		app.errorJSON(w, err)
		return
	}
...
func (app *Config) DeleteSubProjectNote(w http.ResponseWriter, r *http.Request) {
	...
	request, err := http.NewRequest("POST", endpoint, bytes.NewBuffer(jsonData))
	if err != nil {
		log.Println("POST - DeleteSubProjectNote", err)
		app.errorJSON(w, err)
		return
	}
	...
	response, err := client.Do(request)
	if err != nil {
		log.Println("client.Do - DeleteSubProjectNote", err)
	...
	err = json.NewDecoder(response.Body).Decode(&jsonFromService)
	if err != nil {
		log.Println("json.NewDecoder - DeleteSubProjectNote", err)
		app.errorJSON(w, err)
		return
	}
